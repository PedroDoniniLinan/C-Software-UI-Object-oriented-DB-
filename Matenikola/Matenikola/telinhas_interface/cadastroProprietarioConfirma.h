...
namespace Matenikola {
	...
	/// <summary>
	/// Summary for cadastroProprietarioConfirma
	/// </summary>
	public ref class cadastroProprietarioConfirma : public System::Windows::Forms::Form
	{
	public:
		cadastroProprietarioConfirma(System::Windows::Forms::Form ^ anterior, Controlador * con) :anterior(anterior),con(con)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &cadastroProprietarioConfirma::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &cadastroProprietarioConfirma::button2_Click);
			// 
			// label14
			// 
			...
			this->Name = L"cadastroProprietarioConfirma";
			this->Text = L"cadastroProprietarioConfirma";
			this->Load += gcnew System::EventHandler(this, &cadastroProprietarioConfirma::cadastroProprietarioConfirma_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void cadastroProprietarioConfirma_Load(System::Object^  sender, System::EventArgs^  e) {
	}
